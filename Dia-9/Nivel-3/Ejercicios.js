...
*/
const sortNameCountries=countries_data.sort((a,b)=>a.name.localeCompare(b.name));
//console.log(sortNameCountries);
const sortCapitalCountries=countries_data.sort((a,b) => a.capital.localeCompare(b.capital));
//console.log(sortCapitalCountries);
const sortPopulationCountries=countries_data.sort((a,b)=>b.population-a.population);
//console.log(sortPopulationCountries);
/*
...
function CountLanguages(arr) {
    ...
    return Object.entries(res).map(([country,count])=>({country,count}));
}
