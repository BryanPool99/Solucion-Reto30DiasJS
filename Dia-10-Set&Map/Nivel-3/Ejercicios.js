...
for (const i of countries_data) {
    languages.push(i.languages);
}
//lo que hace flat() es que a los array dentro del array los transforma en simples elementos
const arrLanguages=languages.flat();
const setLanguages=new Set(arrLanguages);
//console.log(setLanguages);
console.log(setLanguages.size);
/*
