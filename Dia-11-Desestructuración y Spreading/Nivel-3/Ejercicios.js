...
for (const {Name,capital,population,languages} of countries_data) {
    //console.log(`Pais:${name},Capital:${capital},Poblacion:${population},Idiomas:[${languages}]`);
}
/*
...
*/
const estudiante = ["David", ["HTM", "CSS", "JS", "React"], [98, 85, 90, 95]];
let [nombre,skills,scores]=estudiante;
nombre=nombre+" ("+skills.length+")";
let jsScore,reactScore;
for (let i = 0; i < skills.length; i++) {
    if (skills[i].includes("JS")) {
            jsScore=scores[i];
    }
...
function convertArrayToObject(students) {
    const obj=students.map(([name,skills,scores])=>({name,skills,scores}));
    return obj;
}
//console.log(convertArrayToObject(students));
/*
